package com.dream.database.databasedemo.jdbc;
...
public class PersonJdbcDao {
	...
	class PersonDaoRowMapper implements RowMapper<Person>{
	...
	public List<Person> findAll(){
		...
		return jdbcTemplate.query("select * from person", new PersonDaoRowMapper());
	}
